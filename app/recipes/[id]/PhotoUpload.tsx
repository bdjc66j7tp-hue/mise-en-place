...
export default function PhotoUpload({ recipeId, photoUrl, recipeTitle }: Props) {
  ...
  return (
    <div style={{ width: '100%', aspectRatio: '16 / 10', borderRadius: '12px', background: '#3B6D11', border: '0.5px solid #639922', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', textAlign: 'center', position: 'relative' }}>
      ...
      <div style={{ fontSize: '13px', color: '#C0DD97', fontWeight: '500', marginBottom: '4px' }}>Add your own photo</div>
      <div style={{ fontSize: '11px', color: '#97C459', lineHeight: '1.5', marginBottom: '14px', maxWidth: '320px' }}>Out of respect for the recipe publisher we don&apos;t display their photos — but we&apos;d love to see yours.</div>
